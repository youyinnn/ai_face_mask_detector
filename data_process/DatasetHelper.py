...
mask_label_name_list = list(label_map.values())
mask_gen_label_name_list = list(label_map_new_gen.values())
mask_race_label_name_list = list(label_map_new_race.values())
